...
WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Name_name'), 'a')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/input_Price_price'), '2')

WebUI.setText(findTestObject('Page_Tokobuah Admin - Products/textarea_Description_description'), 'a')
